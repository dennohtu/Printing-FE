...
const CropProduction = ({ SegmentId }) => {
  ...
  const cols = [
    ...
    },
    {
      ...
      minWidth: 150,
      renderCell: ({ row }) => {
        if (row.dateHarvested)
          return new Date(row.dateHarvested).toDateString();
        else return " ";
      },
    },
    {
    ...
    {
      field: "productionDaily",
      headerName: "Daily Production",
      minWidth: 150,
      renderCell: ({ row }) => {
        return `${row.productionDaily} kgs`;
      },
    },
    {
      field: "productionWeekly",
      headerName: "Weekly Production",
      minWidth: 150,
      renderCell: ({ row }) => {
        return `${row.productionWeekly} kgs`;
      },
    },
    {
      field: "productionMonthly",
      headerName: "Monthly Production",
      minWidth: 150,
      renderCell: ({ row }) => {
        return `${row.productionMonthly} kgs`;
      },
    },
    {
      field: "photo",
  ...
  const mutation = useMutation(() => {
    return axios
      .get(
        `
        ${Environment.BaseURL}/api/cropproduction/readAllCropProduction?Segments_ID=${SegmentId}`,
        {
          headers: {
