...
const AnimalTreatment = ({ SegmentId }) => {
  ...
  const mutation = useMutation(() => {
    return axios
      .get(
        `
        ${Environment.BaseURL}/api/animalTreatment/readAllAnimalTreatment?Segments_ID=${SegmentId}`,
        {
          headers: {
