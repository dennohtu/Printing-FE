...
const AnimalSales = ({ SegmentId }) => {
  ...
  const cols = [
    ...
    },
    {
      ...
      minWidth: 150,
      renderCell: ({ row }) => {
        return new Date(row.sale_date).toLocaleDateString();
      },
    },
    {
      field: "animal",
    ...
    { field: "sold_to", headerName: "Sold To", minWidth: 150 },
    { field: "sold_by", headerName: "Sold By", minWidth: 150 },
  ];
  ...
  const mutation = useMutation(() => {
    return axios
      .get(
        `
        ${Environment.BaseURL}/api/animalSales/readAllAnimalSales?Segments_ID=${SegmentId}`,
        {
          headers: {
