...
const PoultryProduction = ({ SegmentId }) => {
  ...
  const cols = [
    ...
    { field: "number_of_eggs", headerName: "Eggs Produced", minWidth: 150 },
    {
      field: "photo",
      headerName: "Photo",
      minWidth: 150,
  ...
  const mutation = useMutation(() => {
    return axios
      .get(
        `
        ${Environment.BaseURL}/api/Poultry/readAllPoultry?Segments_ID=${SegmentId}`,
        {
          headers: {
