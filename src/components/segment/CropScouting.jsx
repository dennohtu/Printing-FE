...
const CropScouting = ({ SegmentId }) => {
  ...
  const cols = [
    ...
    {
      field: "growthProcess",
      headerName: "Growth Process",
      minWidth: 150,
    },
    {
      field: "monitoringProcess",
      headerName: "monitoring Process",
      minWidth: 150,
    },
    {
      field: "photo",
  ...
  const mutation = useMutation(() => {
    return axios
      .get(
        `
        ${Environment.BaseURL}/api/CropScouting/readAllCropScouting?Segments_ID=${SegmentId}`,
        {
          headers: {
